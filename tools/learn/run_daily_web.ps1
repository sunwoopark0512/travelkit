...
powershell -File skills/web_ingest_fetch/src/fetch.ps1 -UrlListFile $UrlList

Write-Host "[2/4] Extracting..."
powershell -File skills/web_ingest_extract/src/extract.ps1

Write-Host "[3/4] Packing KB..."
powershell -File skills/web_ingest_pack_kb/src/pack.ps1 -OutKB "data/learn/kb.jsonl"

Write-Host "[4/4] Generating Problems from KB..."
powershell -File skills/physics_problem_generator/src/generate.ps1 -Topic $Topic -Count $Count -KB "data/learn/kb.jsonl"
