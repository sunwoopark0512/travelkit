// pages/cooperative-trip-create/cooperative-trip-create.js
const { checkTestApi, tripTemplateApi, templateItemApi,pictureCrawlerApi } = require('../../utils/api.js');
...
Page({
  ...
  // 加载城市图片（前端爬虫）
  async loadCityPicture(displayName, options = {}) {
  ...
  async handleCreate() {
    ...
    try {
      ...
      const response = await cooperativeTripApi.create(tripData);
